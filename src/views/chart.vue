<template>
    <div id="chart">
            ...
            <!-- 显示聊天记录 -->
            <div style="margin: 1.2rem 0.1rem 1.5rem;font-size: 0.4rem;overflow-y: scroll;overflow-x: hidden;">
                ...
                >
                    ...
                    <div class="left_msg" v-if="item.infor_source==2">
                        <img :src='targetUser.user_avatar' alt='头像'>
            ...
            <footer id="sendComment">
                ...
                <input type='button' class="commentBtn" :disabled="newsText==''" @click="sendNews" value="发送">
            </footer>
    </div>
</template>
        ...
        getMsg(){
            ...
            getMsgRecord(user_id).then(res=>{
                ...
                let result = res.data.msg.filter(data => {
                    return ((data.user_id == user_id&&data.target_users._id==this.targetUser._id)||(this.targetUser._id == data.user_id&&data.target_users._id==user_id))
                });
